...
struct card {
  ...
  int main () {
    ...
    float GDPpercapitacard1 = card1.GDP / card1.population; 
    float populationdensitycard1 = card1.population / card1.area; 
    float GDPpercapitacard2 = card2.GDP / card2.population; 
    float populationdensitycard2 = card2.population / card2.area; 
    ...
    printf("\nCard #1: GDP per capita: %f - population density: %f\n", GDPpercapitacard1, populationdensitycard1);
    printf("\nCard #2: GDP per capita: %f - population density: %f\n", GDPpercapitacard2, populationdensitycard2);
